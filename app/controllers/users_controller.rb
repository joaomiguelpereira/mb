class UsersController < ApplicationController
	...
	def has_access?
		#if this is a staffer
		staffer = Staffer.find_by_id(params[:id])
		if staffer && @current_user.business_admin?
			#chech if the current user is a business_admin

			#get the business_account
			business_account = @current_user.business_account
			if business_account.id == staffer.business_account_id
			return
